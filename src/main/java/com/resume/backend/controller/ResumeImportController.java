...
//
//    @PostMapping("/extract")
//    public ResponseEntity<?> extractResumeData(@RequestParam("file") MultipartFile file) {
//        if (!isUserPro()) {
...
//    public ResponseEntity<?> cloneDesign(@RequestParam("file") MultipartFile file) {
//        if (!isUserPro()) {
//            return ResponseEntity.status(HttpStatus.FORBIDDEN)
